...
const experience = [
  {
    ...
    desc: "Experienced software engineer with 3 years of freelancing experience. Built 10+ applications for SMBs and diverse clients — across web, desktop, and game development.",
    bullets: [
      ...
      "Offered services in web, game, and desktop app development",
      ...
      "Built full-stack systems for property management platforms including multi-tenant SaaS architecture; e-commerce, financial systems, interactive games, and internal desktop tools",
    ],
    stack: ["Spring Boot", "PHP", "PostgreSQL", "MySQL", "JavaScript", "HTML", "CSS", "Laravel", "Node.js", "React", "Unity", "PHP", "Java", "Java Swing"],
  },
  {
    period: ["May 2026", "August 2026"],
    type: "Contract",
    company: "St. John Fisher School",
    role: "Software Developer",
    desc: "Worked on a multi-campus school cash flow system as a full stack web developer, supporting two campuses.",
    bullets: [
      "Developed a cash flow system supporting two campuses for a private school in Imus, Cavite",
      "Implemented core system functionalities —REST API, CRUD, pagination, reconciliation, audit trail, and role-based access control",
      "Handled full project lifecycle — from requirements, implementation, to deployment and handover",
      "Designed normalized database schema using MySQL with proper foreign key relationship and indexes",
      "Built responsive SSR interfaces using PHP, HTML, CSS, and JavaScript",
      "Utilized PHP as backend for rapid web development and cheaper deployment cost",
    ],
    stack: ["PHP", "MySQL", "HTML5", "Tailwind CSS", "JavaScript (ES6+)", "Monolith"],
  },
  {
...
const projects = [
  ...
  },
  {
    ...
    stack: ["Java", "Java Swing", "Java Database Connectivity (JDBC)", "SQLite", "Maven"],
